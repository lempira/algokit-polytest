...
import type {
  FieldType,
  ModelMetadata
} from "@algorandfoundation/algokit-utils/packages/algod_client/src/core/model-runtime";
...
function fieldTypeToZodSchema(
  ...
  if (fieldType.kind === "model") {
    const meta =
      typeof fieldType.meta === "function" ? fieldType.meta() : fieldType.meta;
 ...
 */
function modelMetadataToZodSchemaInternal(
  meta: ModelMetadata,
  cache: SchemaCache
): z.ZodTypeAny {
